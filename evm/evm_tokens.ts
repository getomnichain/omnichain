...
// USDC uses lowercase to bypass EIP-55 mixed-case validation — Python
// assets.py:94 mis-cases this literal; TS EvmAddress rejects mis-checksummed
// mixed-case at import time. EURC's Python literal is already valid EIP-55.
